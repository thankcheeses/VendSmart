...
import type { MachineAlert, AlertSeverity, AlertType } from '@/types';
...
export default function AlertsPage() {
  const [alerts, setAlerts] = useState<MachineAlert[]>(allAlerts);
  ...
  const groupedAlerts = sortedAlerts.reduce(
    (groups, alert) => {
    ...
    {} as Record<string, MachineAlert[]>
  );

  const dateLabels: Record<string, string> = {
    '2026-05-30': 'Today',
    '2026-05-29': 'Yesterday',
    '2026-05-28': 'Earlier This Week',
    '2026-05-27': 'Earlier This Week',
  };
        ...
        {filterOptions.map((f) => (
          <button
            ...
            style={{
              ...
              color:
                filter === f ? 'var(--accent-blue)' : 'var(--text-secondary)',
              border:
                filter === f
      ...
      <div className="space-y-6">
                  ...
                  >
                    ...
                    <div className="flex-1 min-w-0">
                      <div className="flex items-center gap-2 mb-0.5">
                        ...
                        {alert.acknowledged && (
                          <span className="status-badge-neutral flex items-center gap-0.5">
                            <Check size={10} /> ack
                          </span>
                        )}
                      </div>
        ...
        {sortedAlerts.length === 0 && (
          <div className="glass-card text-center py-16">
            <Check
              size={36}
              style={{ color: 'var(--accent-green)', margin: '0 auto' }}
            />
            <p
